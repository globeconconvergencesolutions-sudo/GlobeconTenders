    ...
    <div className="relative z-10 shrink-0 border-t border-white/[0.08] bg-[hsl(222_47%_7%)]/95 px-4 py-3 pb-[max(0.75rem,env(safe-area-inset-bottom))] shadow-[0_-12px_32px_rgba(0,0,0,0.45)] backdrop-blur-md">
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          title="Sign out"
          className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl border border-white/[0.08] text-slate-400 transition-colors hover:border-red-400/40 hover:bg-red-500/15 hover:text-red-200"
          aria-label="Sign out"
        >
